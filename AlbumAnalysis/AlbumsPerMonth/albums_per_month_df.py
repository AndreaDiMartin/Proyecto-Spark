...
albums_per_month = df.groupBy("year_of_release", "month_of_release")\
                    .agg(count_distinct(col("artist_name"), col("album_name"))\
                    .alias("number_of_albums"))\
                    .sort("year_of_release", "month_of_release")
...
albums_per_month.\
        ...
        .format("json")\
        .mode("overwrite")\
        .save("file:///home/hadoop/Proyecto-Spark/AlbumAnalysis/AlbumsPerMonth/output_df.json")
