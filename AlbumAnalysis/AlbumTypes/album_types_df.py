...
albums_per_day = df.groupBy("year_of_release", "album_type")\
                    .agg(count_distinct(col("artist_name"), col("album_name"))\
                    .alias("number_of_albums"))\
                    .sort("year_of_release", "album_type")
...
albums_per_day.\
        ...
        .format("json")\
        .mode("overwrite")\
        .save("file:///home/hadoop/Proyecto-Spark/AlbumAnalysis/AlbumTypes/output_df.json")
