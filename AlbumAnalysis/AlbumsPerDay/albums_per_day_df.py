...
albums_per_day = df.groupBy("year_of_release", "day_of_release")\
                    .agg(count_distinct(col("artist_name"), col("album_name"))\
                    .alias("number_of_albums"))\
                    .sort("year_of_release", "day_of_release")
...
albums_per_day.\
        ...
        .format("json")\
        .mode("overwrite")\
        .save("file:///home/hadoop/Proyecto-Spark/AlbumAnalysis/AlbumsPerDay/output_df.json")
