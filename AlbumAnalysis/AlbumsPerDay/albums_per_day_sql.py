...
albums_per_day = spark.sql(""" 
                            SELECT 
                                year_of_release, day_of_release, COUNT(DISTINCT artist_name, album_name) AS number_of_albums
                            FROM AlbumsPerMonth
                            GROUP BY year_of_release, day_of_release
                            ORDER BY year_of_release, day_of_release
                            """)
...
albums_per_day.\
        ...
        .format("json")\
        .mode("overwrite")\
        .save("file:///home/hadoop/Proyecto-Spark/AlbumAnalysis/AlbumsPerDay/output_sql.json")
