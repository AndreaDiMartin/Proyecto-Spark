...
albums_per_weekday = df.groupBy("year_of_release", "weekday_of_release")\
                    .agg(count_distinct(col("artist_name"), col("album_name"))\
                    .alias("number_of_albums"))\
                    .sort("year_of_release", "weekday_of_release")
...
albums_per_weekday.\
        ...
        .format("json")\
        .mode("overwrite")\
        .save("file:///home/hadoop/Proyecto-Spark/AlbumAnalysis/AlbumsPerWeekday/output_df.json")
